            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('admin.borrow.add')}}" class="nav-link {{request()->is('admin/borrow/add') ? 'active' : ''}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Borrow</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('admin.borrow.list')}}" class="nav-link {{request()->is('admin/borrow/list') ? 'active' : ''}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Borrow</p>
                            </a>
                        </li>
