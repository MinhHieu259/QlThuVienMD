<div>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form wire:submit.prevent="updateBook" action="">
                        <div class="card">
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4 @error('author_id') is-invalid @enderror"  style="width: 100%;"
                                                ...
                                                <option value="">Select Author Book</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4 @error('publisher_id') is-invalid @enderror"  style="width: 100%;"
                                                ...
                                                <option value="">Select Publisher Book</option>
                                            ...
                                            <div class="custom-file">
                                                ...
                                                @if ($photo)
                                                    <img src="{{ $photo->temporaryUrl() }}" width="50" height="50" style="object-fit: cover"
                                                         class="img">
                                                @else
                                                    <img src="{{ Storage::disk('images')->url($state['image']) ?? '' }}" width="50" height="50" style="object-fit: cover"
                                                         class="img">
                                                @endif
                                            </div>
                                        </div>
