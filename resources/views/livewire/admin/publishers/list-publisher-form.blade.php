                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <div>
                            <a href="{{route('admin.publisher.create')}}">
                                <button class="btn btn-primary">Add New Publishers</button>
                            </a>

                        </div>

                        <x-search-input wire:model="searchTerm" placeholder="Input Publisher Name"/>
                                ...
                                @forelse($publishers as $index=>$publisher)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="" wire:click.prevent="confirmPublisherRemoval('{{$publisher->_id}}')">
